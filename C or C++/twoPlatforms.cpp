...
void solve()
{
    ...
    for(int i=0;i<t;i++)
    {
        ...
        //TODO: implement queue Q
        //      1. push first element from xf
        //      2. i = second element from xf
        //      3. if i->first - Q.front() > k then execute following steps else go to 
        sort(x,x+n);
        //till here we have a sorted array x and corresponding frequency of each point having x-coordinate x[i] as xf[x[i]]
        //TODO: find out a more correct algorihm than the following one
        queue<int> Q;
        Q.push(x[0]);
        //unordered_map<int,int>::iterator it = xf.begin();
        int it = 1,nowpos=0;
        ...
        //FINAL:-   x = sorted array of x co-ordinates
        //          y = number of points in this group of points
    }
}
int main()
{
